Siges.controller('UsersController', ['$scope', 'usersService', '$anchorScroll', function($scope, usersService, $anchorScroll) {
    $scope.form = {};
    $scope.nextPage = 1;
    $scope.NoResults = 0;
...
Siges.factory('usersService', ['$http', function($http){
    return {
